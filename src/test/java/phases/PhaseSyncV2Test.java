...
class PhaseSyncV2Test {
  @Test
  void usageExample() {
    PhaseSyncV2 phaseSync = new PhaseSyncV2();
  ...
  public void errorIfDoneIsNotCalled() {
    assertThrows(IllegalStateException.class, () -> {
      PhaseSyncV2 phaseSyncV2 = new PhaseSyncV2();
      phaseSyncV2.doneWith("first");
      phaseSyncV2.waitFor("first");
      phaseSyncV2.waitForAllPhases();
    });
  }
